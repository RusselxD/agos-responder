...
export default function AlertDetails() {
    ...
    return (
        ...
        >
            <div
                className={`absolute bottom-0 left-0 right-0 max-h-[80dvh] overflow-y-auto rounded-t-2xl bg-white dark:bg-slate-800 p-4 shadow-2xl transition-transform duration-300 ease-in-out ${
                ...
                {chosenAlert && (
                    <div className="space-y-4">
                        <div className="w-full flex justify-center">
                            <div className="h-1.5 rounded-full w-16 bg-gray-300 dark:bg-slate-600"></div>
                        </div>
